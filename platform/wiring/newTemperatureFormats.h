...
static temp_diff_long toLong(temp_diff & val){
    temp_diff_long copy((TEMP_BASE_CLASS &) val);
    return copy;
}
/*
static temp_long toLong(temp & val){
    temp_diff_long copy((TEMP_BASE_CLASS &) val);
    return copy;
}

static temp_diff_precise toPrecise(temp_diff & val){
    temp_diff_precise copy((TEMP_BASE_CLASS &) val);
    return copy;
}

static temp_precise toPrecise(temp & val){
    temp_diff_precise copy((TEMP_BASE_CLASS &) val);
    return copy;
}*/
